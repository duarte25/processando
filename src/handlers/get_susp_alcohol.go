...
// @Accept json
// @Produce json
// @Param data query string true "Identificador dos dados a serem recuperados (ex.: data_susp_alcohol_2022)" sendo os 4 últimos dígitos o ano a ser pesquisado, estando presente na base de dados os anos de 2018 a 2023.
// @Success 200 {array} string "Lista de suspeito de álcool"
// @Router /susp_alcohol [get]
func ListSuspAlcohol(w http.ResponseWriter, r *http.Request) {
